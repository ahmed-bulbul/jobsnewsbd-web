...
export default async function HomePage() {
  ...
  // Build category → type slug lookup
      ...
      <main>
        ...
        <div className="bg-primary-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 grid grid-cols-3 divide-x divide-primary-700">
            {[
              { label: 'মোট বিজ্ঞপ্তি', en: 'Total Circulars', value: latestPosts.totalElements },
              { label: 'বিভাগ', en: 'Categories', value: categories.length },
              { label: 'ধরন', en: 'Job Types', value: categoryTypes.length },
            ].map((s) => (
