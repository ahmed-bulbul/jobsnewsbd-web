        ...
        <div className="card p-6 sm:p-8">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 mb-8">
            ...
            <p className="text-sm text-amber-900 leading-relaxed">
              {t(
                'জব রাডার (Job Radar) কোনো সরকারি প্রতিষ্ঠান নয় এবং বাংলাদেশ সরকার বা এর কোনো মন্ত্রণালয়/দপ্তরের সাথে আনুষ্ঠানিকভাবে সম্পৃক্ত, অনুমোদিত বা অধিভুক্ত নয়। এটি একটি স্বাধীন, বেসরকারি তথ্য-সংকলন প্ল্যাটফর্ম। এখানে প্রকাশিত সরকারি চাকরির বিজ্ঞপ্তিগুলো সংশ্লিষ্ট মন্ত্রণালয়, দপ্তর, বিশ্ববিদ্যালয়, ব্যাংক ও স্বায়ত্তশাসিত সংস্থা/কর্পোরেশনের নিজস্ব অফিসিয়াল ওয়েবসাইট ও প্রজ্ঞাপন থেকে সংগ্রহ করা হয় — যেমন বাংলাদেশ সরকারি কর্ম কমিশন (bpsc.gov.bd), বাংলাদেশ ব্যাংক (bb.org.bd), ডেসকো (desco.gov.bd), নেসকো (nesco.gov.bd), বিভিন্ন সরকারি বিশ্ববিদ্যালয় ও অন্যান্য মন্ত্রণালয়/দপ্তর। আবেদনের লিংক সাধারণত সংশ্লিষ্ট প্রতিষ্ঠানের নিজস্ব ওয়েবসাইট অথবা বাংলাদেশ সরকারের রাষ্ট্রায়ত্ত প্রতিষ্ঠান টেলিটক বাংলাদেশ লিমিটেড কর্তৃক পরিচালিত সরকারি অনলাইন নিয়োগ আবেদন পোর্টালের (teletalk.com.bd — প্রতিটি নিয়োগের জন্য আলাদা সাব-ডোমেইন ব্যবহৃত হয়, যেমন এই উদাহরণটি: tax16.teletalk.com.bd) মাধ্যমে দেওয়া হয়। সরকারের সকল অফিসিয়াল ওয়েবসাইট ও নিয়োগ বিজ্ঞপ্তির কেন্দ্রীয় তালিকা বাংলাদেশ সরকারের জাতীয় তথ্য বাতায়নেও (bangladesh.gov.bd) পাওয়া যায়। প্রতিটি বিজ্ঞপ্তির বিস্তারিত পাতায় সম্ভব ক্ষেত্রে মূল উৎসের লিংক দেওয়া থাকে — চূড়ান্ত সিদ্ধান্তের আগে অনুগ্রহ করে সেই মূল সরকারি উৎস থেকে তথ্য যাচাই করে নিন।',
                'Job Radar is not a government entity and is not officially affiliated with, endorsed by, or connected to the Government of Bangladesh or any of its ministries/departments. It is an independent, privately-run information platform. Government job circulars published here are collected from the respective ministry, department, university, bank, or autonomous body/corporation\'s own official website and notices — for example the Bangladesh Public Service Commission (bpsc.gov.bd), Bangladesh Bank (bb.org.bd), DESCO (desco.gov.bd), NESCO (nesco.gov.bd), various public universities, and other ministries/departments. Application links are typically provided via the respective organization\'s own website, or via the Government of Bangladesh\'s state-owned Teletalk Bangladesh Ltd.\'s official online recruitment application portal (teletalk.com.bd — each recruitment uses its own subdomain, e.g. tax16.teletalk.com.bd). A central directory of official Bangladesh government websites and recruitment notices is also available on the Government of Bangladesh\'s National Web Portal (bangladesh.gov.bd). Where available, each circular\'s detail page links to its original source — please verify with that official government source before making any final decision.'
              )}
            </p>
          </div>
